...
train_preds <- predict(final_rf_model, train_data, type = "response")
test_preds <- predict(final_rf_model, test_data, type = "response")
...
ts_data_monthly <- ts(monthly_data$ANC, frequency=36, start=c(2023, 1))  # 12 for monthly data
...
# Forecast for 24 months (2024 and 2025)
forecast_arima <- forecast(ts_data_monthly, h = 24)

# Plot the forecast
plot(forecast_arima, main = "ARIMA(0,1,0) Forecast for 2024 and 2025")
