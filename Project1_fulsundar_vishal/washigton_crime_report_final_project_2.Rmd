...
Lets start with the Stastical test now
 ...
 Chi-Square Test Results - (shift and offence type)
...
Chi_square test ( Offence Type VS Method )
```{r}
# Load necessary library
library(dplyr)
...
# **MAP conculsion by-** 
 Offenses by Ward in Washington, DC (Midnight Shift & Robbery)--
...
```
# ** Model for Gun crime predicatiom** 
